...
function InputForm( {onSubmit, question, choiceOne, choiceTwo, choiceThree, correctChoice, trivia} ) {  
  return (
        ...
        <input type="text" placeholder="enter choice 4" defaultValue={trivia.answer.choices[3]} ref={choiceThree}></input> 
